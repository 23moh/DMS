...
import { faChartLine, faIndianRupee,  faLocationDot,  faMessage,  faPeopleGroup,  faPhone,  faRupeeSign, faUpload, } from "@fortawesome/free-solid-svg-icons";
            ...
            <div>
                <div className="main1">
                    ...
                    <div className="feild_set1">
                        <div className="fs1">
                            <p><fieldset>
                                <legend><FontAwesomeIcon icon={faLocationDot} />Locations</legend>
                                Bellendur</fieldset></p>
                        </div>
                        <div className="fs1">
                            <p><fieldset>
                                <legend><FontAwesomeIcon icon={faChartLine} />Minimum Investment</legend>
                                25 lakhs</fieldset></p>
                        </div>
                        <div className="fs1">
                            <p><fieldset>
                                <legend><FontAwesomeIcon icon={faRupeeSign} />Target IRR</legend>
                                19 %</fieldset></p>
                        </div>
                    </div>
                    <div className="feild_set2">
                        <div className="fs2">
                            <p><fieldset>
                                <legend><FontAwesomeIcon icon={faIndianRupee} />Total Bucket</legend>
                                60 crore</fieldset></p>
                        </div>
                        <div className="fs2">
                            <p><fieldset>
                                <legend><FontAwesomeIcon icon={faUpload} />Status</legend>
                                100% Funded(Over Subscribed) </fieldset></p>
                        </div>
                        <div className="fs2">
                            <p><fieldset>
                                <legend><FontAwesomeIcon icon={faPeopleGroup} />No of Asset Owners</legend>
                                100</fieldset></p>
                        </div>
                    </div>
                    <div className="msg">
                ...
                <div className="main2">
                    <div className="con1">
                        ...
                        <div className="table1">
                            <div className="trow1">
                                <p><FontAwesomeIcon icon={faMessage} />7036526615</p>
                            </div>
                            <div className="trow2">
                                <p><FontAwesomeIcon icon={faPhone} />7036526615</p>
                            </div>
