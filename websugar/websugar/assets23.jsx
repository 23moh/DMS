...
import { faChartLine, faIndianRupee, faLocationDot, faPeopleGroup, faPhone, faRupee,  faSpinner } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="main2">
                    <div className="con1">
                        ...
                        <div className="table1">
                            <div className="trow1">
                                <p className="ico1"><FontAwesomeIcon icon={faPhone} id="i1"></FontAwesomeIcon>7036526615</p>
                            </div>
                            <div className="trow2">
                                <p className="ico1"><FontAwesomeIcon icon={faWhatsapp} id="i1"></FontAwesomeIcon>7036526615</p>
                            </div>
                    ...
                    <div className="con2">
                        ...
                        <div className="con2_social">
                            ...
                            <p><a href="#"><FontAwesomeIcon icon={faWhatsapp}></FontAwesomeIcon>Instagram</a></p>
